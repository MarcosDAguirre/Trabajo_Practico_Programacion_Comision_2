	...
	with open (dato, encoding = 'cp1252') as f:
		for i in f:
			...
			if len(linea) == 10:
				...
				salida[ciudad] = {'Fecha':fecha,'Hora':hora,'Condición del cielo':c_cielo,'Visibilidad':visibilidad,'Temperatura':temperatura,'Sensación térmica':s_térmica,'Humedad':humedad,'Viento':viento,'Presión':presion}
